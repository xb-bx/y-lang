...
public class StructDefinitionStatement : Statement 
{
    ...
    public StructDefinitionStatement(string name, List<FieldDefinitionStatement> fields, List<ConstructorDefinitionStatement> constructors, List<FnDefinitionStatement> methods, Position pos, string file)
